...
const NotificationModal: React.FC<NotificationModalProps> = ({
  ...
  return (
    <div
      className={`w-64 max-h-64 overflow-auto p-4 bg-white absolute   top-14 right-0 rounded-lg transition-all duration-500 shadow-2xl ${isNotification ? 'opacity-1 z-[20] translate-y-[-10px]' : 'opacity-0  z-[-30]'}`}
    >
