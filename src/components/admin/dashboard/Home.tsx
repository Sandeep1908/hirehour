...
const Home:React.FC = () => {
  ...
  ${isSelected === 1 ? 'bg-[#effefd] text-[#114B53] border-[#114B53]' : 'bg-white text-[#6B7588] border-[#6B7588]'} transition-colors duration-500`}>
        ...
        ${selectedOptionEx.length > 0 ? 'bg-[#effefd] text-[#114B53] border-[#114B53]' : 'bg-white  text-[#6B7588] border-[#6B7588]'} transition-colors duration-500`}
                            >
                                <p className="text-[12px] font-semibold"> {selectedOptionEx ? selectedOptionEx : "Number of Applicants"}</p>
                                <MdOutlineKeyboardArrowDown className={`${dropdown === 2 ? 'rotate-180 transition-all duration-500' : ''}`} />
                            </div>
        ...
        ${selectedOptionEx.length > 0 ? 'bg-[#effefd] text-[#114B53] border-[#114B53]' : 'bg-white  text-[#6B7588] border-[#6B7588]'} transition-colors duration-500`}
                            >
                                <p className="text-[12px] font-semibold"> {selectedOptionEx ? selectedOptionEx : "Company Name"}</p>
                                <MdOutlineKeyboardArrowDown className={`${dropdown === 2 ? 'rotate-180 transition-all duration-500' : ''}`} />
                            </div>
                ...
                <div id='mainJobDescription' className='w-full max-w-[1280px] m-auto   h-full flex gap-3  justify-center md:justify-between pt-7  md:px-3'>
                    ...
                    <div className=' md:max-w-[390px] md:w-full ' id='job-card'>
               ...
               {jobFilterData.map((details,id)=>{
                        return(
                            <div key={id} className=' max-w-[845px]   w-full rounded-lg  border'>
                                        ...
                                        <div className=' flex  justify-between '>
                                            ...
                                            <div className="flex justify-between items-center gap-4">
                                                ...
                                                <div className=" px-6 py-2 bg-[#114B53] rounded-full">
                                                    <p className="text-white text-sm font-semibold">View Stats</p>
                                                </div>
                                ...
                                <div className='p-5 overflow-x-hidden overflow-y-auto h-[650px] '>
                                <div
