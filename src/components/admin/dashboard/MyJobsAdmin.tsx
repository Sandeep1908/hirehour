  ...
  return (
    <div>
      ...
      <div className="p-2 md:max-w-[600px]  w-screen overflow-auto scroll-hidden">
       ...
       {/* filters  */}
       <div className="  px-2  pb-1 flex md:max-w-full   overflow-auto md:overflow-hidden  space-x-5 scroll-hidden  ">
          <div className=' max-w-56 md:w-full flex items-center justify-start space-x-2 border border-[#6B7588] md:max-w-60 h-6 rounded-full'>
              <GiSettingsKnobs size={13} className='ml-3  '/>
              <input type="text" className='w-52 text-xs p-1 flex bg-transparent justify-center items-center outline-none placeholder:text-[10px] placeholder:text-[#C7C9D9]  '  placeholder='Filter and search jobs'/>
          </div>
          ...
          <div className='w-fit px-1  flex justify-center items-center       border border-[#6B7588]  rounded-full'>
              <p className='text-xs text-nowrap w-full font-semibold text-[#6B7588]'>Number of Applicants :</p>
