...
import GreatMatch from './Applicants/GreatMatch'
import Shortlisted from './Applicants/Shortlisted'
import Unsure from './Applicants/Unsure'
import ShortListed from './ShortListed'
  ...
  const filterItems = [
    {
      label: 'All Applicants ',
      Number: "8",
      component: <AllApplicants allAppliedJobs={allAppliedJobs}/>
    },
    {
      label: 'Great match ',
      Number: "2",
      component: <GreatMatch/>
    },
    {
    ...
    },
    {
      label: 'Shortlisted ',
      Number: "4",
      component: <Shortlisted allAppliedJobs={allAppliedJobs}/>
    },
    {
      label: 'Unsure ',
      Number: "0",
      component: <Unsure allAppliedJobs={allAppliedJobs}/>
    },
    {
      label: 'Rejected ',
      Number: "2",
      ...
      <div className='  w-full h-auto'>
        <div className="flex flex-col md:flex-row justify-between md:items-center p-3">
          ...
          <div className='flex gap-4'>
            ...
            <p className="  w-24 h-8 md:flex justify-center items-center bg-[#E9F358] text-[#104B53] rounded-full text-xs">
              Post a Job
            </p>
          </div>
        ...
        <div className="p-2 mt-1  flex justify-between">
          ...
          <div onClick={() => { setAddCandidate(!addCandidate) }} className=' w-fit text-[10px] rounded-full    px-3 py-1  cursor-pointer  md:flex justify-center items-center space-x-4 bg-[#104B53]'>
