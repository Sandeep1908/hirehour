...
const Interviews: React.FC = () => {
  ...
  ${isSelected === 1 ? 'bg-[#effefd]' : 'bg-white'} transition-colors duration-500`}>
        ...
        <div className='mt-5 px-4 w-full flex'>
          <div className='p-3 border-[1px] border-[#D6DBDE]  bg-[#EFFEFD] rounded-tl-lg w-fit'>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>3</p>
                       <FaRegEdit />

                 </div>
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>Shortlisted</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit'>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>2</p>
                       <FaRegEdit />

                 </div>
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>RTR</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>3</p>
                 ...
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>Recruiter Screening</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>0</p>
                       <FaRegEdit />

                 </div>
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>1st Interview</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>0</p>
                 ...
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>2st Interview</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>2</p>
                 ...
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>Reference Check</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>1</p>
                       <FaRegEdit />

                 </div>
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>Offer</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>0</p>
                 ...
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>Background Check</p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>0</p>
                 ...
                 <p className='text-sm text-[#114B53] font-semibold mt-3'>Hired </p>
          </div>
          <div className='p-3 border-[1px] border-[#D6DBDE] w-fit '>
                 <div className='flex justify-between gap-10'>
                       <p className='text-sm text-[#114B53] font-semibold'>0</p>
        ...
        <div className='w-full h-auto px-3 relative'>
          ...
          <div className='w-full h-[290px] overflow-x-hidden overflow-y-auto mt-2'>
