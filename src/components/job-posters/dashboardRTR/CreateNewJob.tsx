    ...
    <div className="w-full h-full">
      ...
      <div className="w-full h-[82vh]  flex justify-center items-center ">
            <div className='flex flex-col justify-center items-center max-w-5xl space-y-5'>
                ...
                <h1 className='text-sm font-semibold text-center'>Access Limited: Please Post a Job to Unlock Full Features</h1>

                <p className='text-xs text-center'>You're currently viewing a limited version of TopEquator. To gain full access to all job postings, employer tools, and exclusive features, please post a job. Take a moment to post a job and start enjoying the complete benefits of our platform.</p>
