  ...
  return (
    <div className="w-full h-full">
      <div className="flex justify-between items-center p-2">
        <h1 className="text-sm font-semibold">Resume Sourcing</h1>
      </div>
      <hr />
      ...
      <div className="w-full h-[82vh]  flex justify-center items-center ">
            <div className='flex flex-col justify-center items-center max-w-5xl space-y-5'>
                ...
                <p className='text-[10px] font-[500] w-48 flex justify-center items-center rounded-full  h-7 bg-[#E9F358] text-[#104B53]'>Subscribe for Resume Sourcing </p>
            </div>
      </div>
    </div>
  );
