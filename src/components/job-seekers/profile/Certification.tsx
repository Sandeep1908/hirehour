...
const CertificationEdit:React.FC<CertificationProps> = ({setCerticationPopup}) => {
  return (
          ...
          <div>
              <div className='w-full flex gap-4 mt-3 flex-col md:flex-row'>
                <div className='w-full '>
                   ...
                   <input type="text"  className='w-full h-[40px] text-sm rounded-xl border-[1px] border-[#E1E1E2] mt-2 px-4 ' />
                </div>
                <div className='w-full '>
             ...
             <div className='w-full flex gap-4 mt-3 flex-col md:flex-row'>
                <div className='w-full '>
                   ...
                   <input type="number" className='w-full h-[40px] text-sm rounded-xl border-[1px] border-[#E1E1E2] mt-2 px-4 ' />
                </div>
                <div className='w-full '>
                   <p className='text-sm font-medium'>Expiration date <span className='text-red-600'>*</span></p>
                   <input type="date"  className='w-full h-[40px] text-sm rounded-xl border-[1px] border-[#E1E1E2] mt-2  px-4' />
                </div>
             </div>
              </div>
          </div>
