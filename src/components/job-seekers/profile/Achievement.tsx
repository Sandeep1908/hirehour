...
type AchievementProps = {
    setAchievementPopup:(agr:boolean) => void
 }

const Achievement:React.FC<AchievementProps> = ({setAchievementPopup}) => {
  return (
    ...
    <div className='max-w-[700px] h-auto w-full bg-white rounded-lg overflow-y-auto z-[30] p-4'>
        <div className='  flex justify-between items-center'>
            <div className='text-base md:text-xl font-bold'><p>Achievement</p></div>
            <IoMdClose size={30} className="cursor-pointer"  onClick={()=>{setAchievementPopup(false)}}/>
        </div>
        <hr className='mt-3' />
          ...
          <div className='bg-[#F2F2F5] rounded-lg p-4'>
              ...
              <div className='w-full flex gap-4 mt-3 flex-col md:flex-row'>
                <div className='w-full '>
                   <p className='text-base font-medium'>Achievement<span className='text-red-600'>*</span></p>
