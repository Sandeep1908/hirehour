...
const ProfileComplition:React.FC<ProfileProps> = ({setProfilePopup}) => {
  return (
    ...
    <div className='max-w-[533px] h-full w-full bg-white rounded-lg overflow-y-auto z-[30] p-8'>
        <div className='  flex justify-between items-center'>
            <div className='text-base md:text-2xl font-bold'><p>About me</p></div>
        ...
        <div className='w-full mt-5 flex flex-col gap-2 ' >
          <div className='border-[1px] border-[#C7C9D9] rounded-lg p-5 flex justify-between'>
          ...
          <div className='border-[1px] border-[#C7C9D9] bg-[#F2F2F5] rounded-lg p-5 flex justify-between'>
             <div className='flex items-center gap-2'>
        ...
        <div className='w-full flex justify-end  gap-10  items-center mt-5'>
