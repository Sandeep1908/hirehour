      ...
      <div className='w-full h-full absolute opacity-[.7] after:absolute after:left-0 after:w-full after:h-full after:bg-black '></div>
        ...
        <div className='max-w-[1055px] h-[700px] w-full  bg-white rounded-lg  shadow-lg overflow-y-auto z-30'>
            ...
            <div className='w-full p-10'>
              ...
              <div className='border-[1px] rounded-lg p-5 border-black'>
                <p className='text-[#3A3A3C] text-base font-semibold'> Alert Active</p>
              </div>
              <div>
              <div className='w-full flex gap-4 mt-5 flex-col md:flex-row'>
                <div className='w-full '>
                   <p className='text-base font-medium'>Job Tittle</p>
              ...
              <div className='w-full flex gap-4 mt-5 flex-col md:flex-row'>
                <div className='w-full '>
                   <p className='text-base font-medium'>Work mode </p>
                   <select name="" id="" className='w-full h-[48px] rounded-xl border-[1px] border-[#E1E1E2] mt-2 px-4 ' >
                      <option value=""> On Site  </option>
                      <option value=""> Remote </option>
                   </select>                </div>
                <div className='w-full '>
                   <p className='text-base font-medium'>Experience level </p>
                   <select name="" id="" className='w-full h-[48px] rounded-xl border-[1px] border-[#E1E1E2] mt-2 px-4 ' >
            ...
            <p className='text-base font-medium'>Salary preference</p>
            ...
            <div className='w-full flex gap-4 mt-1'>
             ...
             <div className='w-full flex gap-4 mt-5'>
                <div className='w-full '>
                   <p className='text-base font-medium'>Work authorization</p>
                   <select name="" id="" className='w-full h-[48px] rounded-xl border-[1px] border-[#E1E1E2] mt-2 px-4 ' >
            ...
            <div className='w-full flex justify-end p-10'>
                <div  className='bg-[#E9F358] w-[140px] h-[42px] flex justify-center items-center rounded-full '>
                    <p className='text-base font-semibold text-[#114B53]'>Add</p>
                </div>
            </div>
        </div>
    </div>
