  ...
  return (
    <div className='w-full h-[100vh] bg-[#F2F2F5]  py-10'>
       ...
       <div className=' w-full  flex justify-between items-center'>
            ...
            <div className='bg-[#114B53] w-[140px]  h-[42px] flex justify-center items-center rounded-full cursor-pointer relative  ' onClick={()=>{setShowjobAlert(true)}}>
        ...
        <div className='mt-5'>
              <div className='w-full border-[1px] border-black rounded-lg flex p-5'  >
                   <div className='w-full'>
                     <p className='text-sm font-semibold'>Java Full stack Developer </p>
