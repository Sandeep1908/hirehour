            ...
            <ul className="w-full flex">
              {tags?.map((item, id) => {
                return (
                  <Link
                    to={item.link}
                    className={` text-xs  font-[500]  p-5 ${id === 0 ? 'text-[#104B53]' : ''}`}
                    key={id}
                  >
              ...
              {allAppliedJobs?.appliedJobs?.map((item:AppliesJobType,i:number)=>{
                ...
                >
                  ...
                  <div className="w-full flex justify-between items-center space-x-6 ">
                    ...
                    <p
                      className="w-full border border-[#104B53] rounded-full p-1 flex justify-center items-center text-xs"
                      ...
                      <div className="w-36 shadow-md   bg-white absolute  top-0 right-[-140px] rounded-lg  z-[10] transition-all ">
                        <ul className="flex flex-col p-3 space-y-4 text-xs ">
                          {moreSection.map((item, id) => {
                            return (
                              <li key={id} className=" p-1 w-full text-xs border-b">
                                {item}
                              </li>
                            );
                          })}

                          <li className="p-1 w-full text-xs border-b flex  space-x-2 items-center text-red-500">
