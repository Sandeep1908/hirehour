...
{/* Setting Box  */}
    ...
    <div className="flex justify-between items-center">
        <div className="flex flex-col space-y-3">
            ...
            <p className="text-[#404040] text-sm">
                We will hide your name, email, and contact details to employers and if they like your profile, they can send you a message.
            </p>
        </div>
        <input type="radio" name="visibility" id="visible" className="w-10 h-9" />
    </div>
    ...
    <div className="flex justify-between items-center">
        ...
        <input type="radio" name="visibility" id="not-visible" className="w-10 h-9" />
    </div>
</div>
