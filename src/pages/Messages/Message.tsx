                            ...
                            <div className="w-full h-full p-5 relative    ">
                                    ...
                                    <div className="w-full pt-5">
                                            ...
                                            <div className=" flex space-x-3 ">
                                                    <div className="w-[55px] h-[57px] bg-[#E94C89] rounded-lg"></div>
                                                    <div className=" flex flex-col space-y-3">
                                                        ...
                                                        <ul className="flex flex-wrap space-x-3">
                                                            <li className="bg-[#F2F2F5] text-[#3A3A3C]  p-2 text-xs rounded-full text-center">Full Time</li>

                                                            <li className="bg-[#F2F2F5] text-[#3A3A3C]  p-2 text-xs rounded-full text-center">$50-$60 per hour</li>

                                                            <li className="bg-[#F2F2F5] text-[#3A3A3C]   p-2 text-xs rounded-full text-center">Software</li>

                                                            <li className="bg-[#F2F2F5] text-[#3A3A3C]   p-2 text-xs rounded-full text-center">Mid-Senior Level</li>

                                                            <li className="bg-[#F2F2F5] text-[#3A3A3C]   p-2 text-xs rounded-full text-center">H1 Vis</li>
                                    ...
                                    <div className="w-full p-5">
                                            <div className="w-full flex flex-col justify-end items-start space-y-4">
                                                    <div className="flex flex-col space-y-1 justify-end items-end w-full max-w-[302px]">
                                                        <p className="text-sm border border-[#D6DBDE] p-2 rounded-lg">Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                                                        <p className="text-xs text-[#C4C4C4]">5min ago</p>
                                                    </div>
