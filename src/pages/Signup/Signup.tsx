          ...
          <div className="w-[519px] h-[804px]  bg-white px-10 py-12 rounded-md">
            ...
            <form action="">
              ...
              <div className="flex justify-between mt-8">
                <button className="w-[206px] h-[48px] text-base flex items-center rounded-3xl gap-1 justify-center md:gap-2 text-black p-2 box-radius border border-black">
                  <img src={google_logo} alt="Google logo" /> <p>Google</p>
                </button>
                <button className="w-[206px] h-[48px] flex text-base items-center rounded-3xl justify-center gap-1 md:gap-2 text-black p-2 box-radius border border-black ">
