        ...
        <div className="w-full h-full ">
                <div className="max-w-72  m-auto mt-5 bg-white">
                        ...
                        <div className="w-full flex flex-col space-y-2 justify-center items-center pt-2">
                            ...
                            <p className="text-sm font-[300] text-center text-[#3A3A3C] ">You received 6 new messages awaiting 
                            your response</p>
 
                        </div>


                        <div className="w-full h-full pt-5 p-2  ">
                        ...
                        <p className="w-full max-w-[35px] text-xs h-[35px] rounded-full bg-[#A6F3D0] flex justify-center items-center font-semibold">AN</p>
                        ...
                        <div className="w-full flex justify-center items-center ">
                                <p className="text-[6px] font-semibold bg-[#A6F3D0] w-5  h-5 rounded-full flex justify-center items-center">KA</p>
                                <p className="text-[6px] font-semibold bg-[#C3EFF8] w-5  h-5 rounded-full flex justify-center items-center">RA</p>
                                <p className="text-[6px] font-semibold bg-[#CACACA] w-5  h-5 rounded-full flex justify-center items-center">+2</p>
                        </div>

                        <p className="text-[8px] mt-1 text-center text-[#BCBCBC]">View all 3 messages and start engaging</p>
