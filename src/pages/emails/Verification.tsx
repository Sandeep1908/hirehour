...
const VerificationMainTemp:React.FC = () => {
  return (
    ...
    <div className="max-w-72  m-auto mt-5 bg-white">
            ...
            <div className="w-full flex flex-col space-y-2 justify-center items-center pt-2 px-2">
                ...
                <p className="text-xs text-[#3A3A3C] text-center ">Your verification is completed the job was posted successfully. You can track the stats in jobs page</p>
            </div>
...
export default VerificationMainTemp
