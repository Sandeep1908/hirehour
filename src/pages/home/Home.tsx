        ...
        <div className="w-full mb-10 ">
            ...
            <div className="w-full max-w-[1200px]  m-auto p-7 md:p-10 ">
                ...
                <div className="w-full max-w-3xl flex flex-col space-y-4">
                        <h1 className=" relative text-4xl text-white font-bold">Find Your Perfect 
                            ...
                            <span className="text-[#E9F358] ml-1 mr-1  relative box  "> 
                             ...
                             Job or Post
                              ...
                              One Today!</h1>
                        <p className="text-sm text-white">Discover top opportunities and connect with talent on HireHours – your go-to platform for seamless job searching and posting.</p>
                </div>
                            ...
                            <div className="border-[#E7E7E7] border w-full mt-5 rounded-lg flex  justify-center items-center ">
                                ...
                                <div className="flex md:ustify-start p-4 justify-center   items-center flex-wrap">
                                     ...
                                     <div className="relative">
                                        <input type="text" className="p-4 ml-1 w-72 text-xs text-black outline-none  placeholder:text-xs" placeholder="Company name, job Tittle or keywords" />

                                        <IoSearchOutline color="#8D8D8D" size={14} className="absolute top-[16px] ml-1 " />
                                    </div>

                               

                                    <div className="relative">
                                        <input type="text" className="p-4 ml-1 w-64 text-xs text-black outline-none  placeholder:text-xs" placeholder="City, state, zip code or remote" />
                                        <SlLocationPin color="#8D8D8D" size={12} className="absolute top-[18px] ml-1 " />
                                    </div>
                                    ...
                                    <div className="mr-3">
                                        <select name="" id="" className="text-xs text-[#C6C6C6] border-[#C6C6C6]  p-2 rounded-full border-[1px] outline-none">
                                    ...
                                    <div className="mr-2">
                                        <button className=" bg-[#E9F358] flex justify-center items-center text-[#104B53] w-28 h-9 rounded-full text-sm font-[500] cursor-pointer">Search</button>
                                    </div>
                ...
                <div className="mt-2">
                    <p className="text-[#88A5A9] text-xs"> <span className="text-white font-[500]">Popular:</span> Java Developer, UI/UX Designer, Data Engineer, Business Associate</p>
                </div>
            ...
            <div className="w-full max-w-[1200px] mt-10 m-auto">
                ...
                <div className="w-full">
                        <div className="flex justify-center items-center"><h1 className="text-xl font-bold">Resource</h1></div>

                        <div className="w-full mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-4 place-items-center">

                            {homeCards?.map((item,id)=>{
                                return(
<div className="flex flex-col justify-center items-center max-w-80 " key={id}>
                                                
                                                <img src={item.imgUrl} alt="home-card" className="w-full h-44 object-cover rounded-t-lg" />

                                                <div className="flex flex-col w-full space-y-3 p-2  pt-1 border-[2px] border-[#F3F3F3] rounded-b-md">
