                ...
                <h1 className='text-sm font-semibold'>Job Details</h1>
                        ...
                        <div className='grid px-4 gap-5'>
                                ...
                                <div className='flex flex-col space-y-1'>
                                    ...
                                    <ol className='px-4 list-decimal'>
                                        <li className='text-xs font-semibold'>Can you relocate once you get the offer?</li>
                                        <li className='text-xs font-semibold'>How many years of experience do you have in java?</li>
                    ...
                    <div className='w-full border rounded-lg h-full p-2 mt-5 flex flex-col space-y-5'>
                        ...
                        <div className='w-full  h-full p-2 mt-5 flex justify-end items-center space-x-2 '>
                            ...
                            <p className='w-28 flex justify-center items-center rounded-full text-xs h-7 text-[#124C53] border border-[#124C53]'>Job Preview</p>

                            <Link to={'/job-poster/pricing'} className='w-24 flex justify-center items-center rounded-full text-xs h-7 text-[#124C53] border bg-[#E9F358]'>Submit</Link>
