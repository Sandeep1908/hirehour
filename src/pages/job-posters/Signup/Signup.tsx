...
const signupSchema = z.object({
  ...
  isAdvancedRecruiter: z.boolean(), // Expecting a boolean here
});
...
const Signup: React.FC = () => {
  ...
  const [isAdvancedRecruiter, setIsAdvancedRecruiter] = useState<boolean | null>(null);
  ...
  const mutation = useMutation({
    mutationFn: async (newUser: NewUser) => {
      const response = await axiosrecruiterinstance.post('/api/recruiter/signup', newUser);
    ...
    onError: (error) => {
      ...
      setPhoneNumber('');
      setEmail('');
      // setCheckIsAdvancedRecruiter("I am..")
      setPassword('');
      setConfirmPassword('');
    },
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const formData = { firstName, lastName, phoneNumber, email, password, isAdvancedRecruiter };
        ...
        <div className="w-full h-fit md:w-[50%] flex justify-center  md:justify-end ">
          <div className="w-[335px] md:w-[519px] h-auto  bg-white px-5 md:px-8 py-3 rounded-xl">
            ...
            <p className="text-black text-[14px] md:text-sm font-normal mt-1">
              If you are new user create account to continue
            </p>
            <form action="">
                ...
                <div className="grow">
                  ...
                  <div className="w-full h-[40px] mt-1">
                    ...
                    {formErrors.firstName && (
                      <p className="absolute  text-red-500 text-[10px]">{formErrors.firstName}</p>
                    )}
                  </div>
                </div>
                <div className="grow">
                  ...
                  <div className="w-full h-[40px] mt-1">
                    ...
                    />
                    {formErrors.lastName && (
                      <p className="absolute  text-red-500 text-[10px]">{formErrors.lastName}</p>
                    )}
                  </div>
                </div>
              </div>
                      ...
                      const value =
                        e.target.value === 'true'
                          ...
                          : e.target.value === 'false'
                            ? false
                            : null;
                      setIsAdvancedRecruiter(value);
                    }}
                    className="border-[1px] text-sm px-2 border-[#E1E1E2] w-full h-full rounded-lg"
                  >
                    <option value="default">I am..</option>
                    <option value="true">Looking for candidates</option>
                    <option value="false">Representing candidates</option>
                  </select>
                </div>
              </div>
                ...
                <div className="mt-3  grow">
                  ...
                  <div className="w-full h-[40px] mt-1">
                    ...
                    {formErrors.phoneNumber && (
                      <p className="absolute  text-red-500 text-[10px]">{formErrors.phoneNumber}</p>
                    )}
                  </div>
                </div>
                <div className="mt-3  grow">
                  ...
                  <div className="w-full h-[40px] mt-1">
                    ...
                    />
                    {formErrors.email && (
                      <p className="absolute  text-red-500 text-[10px]">{formErrors.email}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-3 md:gap-5 mt-4 ">
                <div className="grow">
                  ...
                  <div className="relative w-full h-[40px] mt-1">
                    ...
                    {formErrors.password && (
                      <p className="absolute  text-red-500 text-[10px]">{formErrors.password}</p>
                    )}
                  </div>
                </div>
                <div className="grow">
