...
const Signup: React.FC = () => {
   ...
   const mutation = useMutation({
      mutationFn: async (newUser: NewUser) => {
         const response = await axiosInstance.post("/api/recruiter/signup", newUser);
               ...
               <div className='w-[335px] md:w-[519px] h-auto  bg-white px-5 md:px-8 py-3 rounded-xl'>
                  ...
                  <form action="">
                     ...
                     <div className='flex justify-center'>
                        ...
                        <Link to={"/job-poster/signin"} className='text-[14px] md:text-[16px] font-semibold mt-12 md:mt-4 text-center'>
