...
const RTRPrivacySetting: React.FC = () => {
...
<hr />
          ...
          {isRTRAlertModalOpen && (
            <div className="w-full h-full flex justify-center items-center fixed inset-0 transition-all duration-500 opacity-1 scale-[1.01]">
              <div className="z-[10] w-full max-w-[350px] shadow-xl bg-white rounded-lg space-y-6 p-6">
                <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col items-center justify-center">
                  <p className="text-[10px] text-center text-[#6B7588]">
                    Your RTR notifications will be turned off and Top Equator will no longer send RTR notifications to your email address.
                  </p>

                  <div className="flex justify-between items-center w-full max-w-[80%] m-auto p-3">
                    <p
                      onClick={() => {
...
export default RTRPrivacySetting;
