        ...
        >
          ...
          {/* Acceptance  */}
            ...
            <div className="w-full flex flex-col space-y-2 p-5 bg-white mt-2">
              ...
              <div className='flex justify-start items-center space-x-3'>
                <input type="checkbox"  className='w-[20px] h-[20px]'/> <p className='text-[#7D8697] text-[10px]'>By accepting this and proceeding further you agreed to the terms &  condition</p>
              </div>
            </div>
           ...
           {/* Signature  */}
                  ...
                  <div className='w-full  p-4 bg-white mt-2 flex justify-between items-end'>
                          <div className='flex flex-col justify-start items-start space-y-2'>
                              <h1 className='text-[10px] font-semibold'>Employer</h1>

                              <div className='flex justify-center items-center space-x-3'>
                                  <div className='flex flex-col items-center justify-center space-y-2'>
                                        <p className='text-[10px] font-sans font-[100] tracking-widest border-b-2 w-full text-center'>Mathew</p>
                                        
                                        <p className='text-[8px]'>Mathew - 08/16/2024</p>
                                  </div>

                                  <p className='text-[#104B53] text-[8px] w-[100px] p-2 rounded-full text-center bg-[#B4FEDD]'>Signed</p>
                              </div>
                          </div>
                          ...
                          <div className='flex flex-col justify-start items-start space-y-3'>
                              <h1 className='text-[10px] font-semibold'>Applicant</h1>

                              <div className='flex justify-center items-center space-x-3'>
                                  <div className='flex flex-col items-center justify-center space-y-2'>
                                       <input type="text" placeholder='Type you name and sign' className='max-w-[240px] w-full outline-none rounded-lg  text-[8px] p-2 border border-[#7D8697]' />
                                  </div>

                                  <p className='text-white text-[8px] w-[100px] p-2 rounded-full text-center bg-[#07A561]'>Sign</p>
                              </div>
                          </div>

                          <div>
                          <p className='text-white w-[100px] text-[8px] p-2 rounded-full text-center bg-[#FF3837]'>Decline</p>
                          </div>
                  </div>
